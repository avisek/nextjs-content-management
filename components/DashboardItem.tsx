...
export default function DashboardItem({ icon, title, summary }: DashboardItemProps) {
  return (
    <div className="px-6 py-9 gap-3 grow basis-0 flex flex-wrap content-center items-center bg-white hover:bg-slate-500/10 active:scale-95 will-change-transform transition rounded-3xl select-none">
      {icon}
      <div className="">
